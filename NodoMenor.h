...
class NodoMenor : public NodoOperacionBinaria
{
public:
    NodoMenor(NodoExpression* izquierdo, NodoExpression* derecho,NodoBasico * basico):NodoOperacionBinaria(izquierdo, derecho,basico)
	{
        this->nodoBasico->nombreNodo = "NodoMenor";
